...
export default function Overview({ users, onStateChange }: {
  ...
  useEffect(() => {
    setCurrentDid(Math.max(users.length - 1, 0))
  }, [users])
  ...
  return <>
    ...
    {users.length ?
      ...
      :
      <p className='pt-10 text-sm text-gray-600 dark:text-neutral-300 mb-1'>
        You don't have any DID of your own. Create one!
      </p>
    }
